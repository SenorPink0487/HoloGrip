...
import workerWasmLoaderPath from '@mediapipe/tasks-vision/vision_wasm_module_internal.js?url';
import workerWasmBinaryPath from '@mediapipe/tasks-vision/vision_wasm_module_internal.wasm?url';
import {
  OCCLUSION_HOLD_MS,
